...
<body>
  ...
  <script>
    const gridData = [
      ...
      [null,null,null,null,null,'Қ','О','Р','Ы','Т','Ы','Н','Д','Ы'],
    ...
    const numbers = {
      '0,7': {num: '1', hint: 'Тезистің немесе мәтіннің белгілі бір тәртіппен орналасқан бөліктері.'},
      '3,3': {num: '2', hint: 'Белгілі бір тақырыпты тереңірек қарастырып, ғылыми түрде талдау үдерісі.'},
      '2,5': {num: '3', hint: 'Бір ұғымның немесе ойдың ішкі мағынасы, мазмұны.'},
      '5,2': {num: '4', hint: 'Мәтіндегі ойдың түсініктілігі, дәл және нақты түрде берілуі.'},
      '6,5': {num: '5', hint: 'Артық сөзсіз, ықшам түрде мазмұнды беру қасиеті.'},
      '7,5': {num: '6', hint: 'Зерттеу немесе ой қорыту барысында алынған қорытынды мәлімет.'},
      '6,7': {num: '7', hint: 'Автордың ойы, шығармашылық тұжырымдамасы немесе негізгі пікір.'},
      '8,5': {num: '8', hint: 'Жазбаның немесе пікірдің соңындағы түйін, жалпы тұжырым.'},
      '9,0': {num: '9', hint: 'Ойдың жүйелілігі мен қисындылығы, тұжырымдардың бірізділігі.'},
    };
      ...
      row.forEach((cell, colIndex) => {
        ...
        if (cell === null) {
          ...
          if (numbers[key]) {
            ...
            num.textContent = numbers[key].num;
            num.title = numbers[key].hint;
